 ...
 * @private
 */
export const CategoryPrismaCreateSchema = baseSchemaWithoutDefaults.partial().passthrough();
...
export const CategoryPrismaUpdateSchema = z.object({
    ...
    isDeletedDT: z.coerce.date().nullish(),
    orderCategory: z.union([z.number(), z.record(z.string(), z.unknown())]),
    name: z.string()
}).partial().passthrough();
 ...
 */
export const CategoryCreateScalarSchema = baseSchemaWithoutDefaults.partial({
 ...
 */
export const CategoryCreateSchema = baseSchemaWithoutDefaults.partial({
    id: true, numSeq: true, createdAt: true, updatedAt: true, published: true, isPublic: true, isDeleted: true
});
 ...
 */
export const CategoryUpdateScalarSchema = baseSchemaWithoutDefaults.partial();
